    ...
    try:
        ...
        while True:
            ...
            if action == "changeName":
                ...
                await give_chats(user_id, websocket)
            elif action == "loadMessages":
                await load_messages(user_id, json_data, websocket)
            elif action == "sendMessage":
                await send_message(user_id, json_data, websocket)
            elif action == "mark_as_read":
                await message_read(json_data, websocket)
            else:
